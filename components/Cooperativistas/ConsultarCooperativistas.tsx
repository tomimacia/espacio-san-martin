...
const ConsultarCooperativistas = () => {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    setLoadingForm(true);
    await getSingleDoc("Cooperativistas", consulta).then((res) => {
      console.log("fetched");
      const registry = res?.data();
      if (!registry) {
        toast({
          title: "No encontrado",
          description: "Regsitrate como cooperativista o contáctate!",
          status: "warning",
          duration: 9000,
          isClosable: true,
        });
            ...
            <TableContainer>
              <Table variant="striped">
                <Tbody>
                  ...
                  <Tr>
                    <Td>Curso/s:</Td>
                    <Td>{registryUser.Cursos}</Td>
                  </Tr>
                  <Tr>
                    <Td>Turno:</Td>
                    <Td>{registryUser.Turno}</Td>
                  </Tr>
                </Tbody>
              </Table>
            </TableContainer>
...
export default ConsultarCooperativistas;
